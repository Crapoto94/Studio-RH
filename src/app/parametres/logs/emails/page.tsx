...
import { Mail, ArrowLeft, Eye, Clock, User, FileText } from 'lucide-react'
    ...
    <AdminGuard>
      <div className="flex bg-[#f4f6fb] text-[#1a2340] min-h-screen">
        ...
        <PageContainer 
          ...
          subtitle="Historique complet des communications sortantes"
        >
          <div className="mb-6 flex items-center gap-4">
            ...
            <PageHeader title="Historique Email" icon={Mail} />
          </div>
            ...
            <Table>
              <TableHeader className="bg-slate-50/50">
                <TableRow>
                  ...
                  <TableHead className="font-bold text-slate-400 uppercase text-[10px] tracking-wider"><div className="flex items-center gap-2"><User size={12} /> Destinataire</div></TableHead>
                  <TableHead className="font-bold text-slate-400 uppercase text-[10px] tracking-wider"><div className="flex items-center gap-2"><FileText size={12} /> Sujet</div></TableHead>
                ...
                {isLoading ? (
                  ...
                  logs.map((log: any) => (
                    <TableRow key={log.id} className="hover:bg-slate-50/50 transition-colors">
                      ...
                      <TableCell className="text-sm text-slate-600 truncate max-w-[300px]">{log.subject}</TableCell>
                          ...
                          <DialogContent className="max-w-2xl bg-white rounded-2xl border-none shadow-2xl">
                            ...
                            <div className="mt-4 space-y-4">
                               <div className="grid grid-cols-4 gap-4 pb-4 border-b border-slate-100 text-sm">
                                  ...
                                  <div className="text-slate-400 font-medium">Sujet :</div>
                                  <div className="col-span-3 font-semibold text-indigo-900">{log.subject}</div>
                               </div>
                               <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
                                  <div className="text-xs font-bold text-slate-400 uppercase mb-4 tracking-widest">Corps du message</div>
